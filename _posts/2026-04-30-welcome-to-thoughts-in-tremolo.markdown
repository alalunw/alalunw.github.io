---
layout: post
title: "Welcome to Thoughts In Tremolo 2.0 — Music Reviews, Book Reviews & Projects"
...
- **Concert Reviews** — live events examined with context and reflection  
  *(e.g. “Back to the Beginning” — Black Sabbath’s final reunion)*  
- **Artist Studies** — long-form pieces on influential figures  
  *(e.g. Ozzy Osbourne)*  
- **Album Analysis** — structured, track-level breakdowns  
...
- **Historical Works** — WWII, military, and social history  
  *(e.g. James Holland’s “Victory ’45”)*  
- **Critical Reviews** — essays that go beyond summary into argument and context  
...
Subscribe via RSS if you want updates — otherwise, dip in when something catches your interest.